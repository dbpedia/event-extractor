...
//        dp.setTokenizerFactory(new CoreLabelTokenFactory(true));
        dp.setTokenizerFactory(new WhitespaceTokenizer.WhitespaceTokenizerFactory<CoreLabel>(new CoreLabelTokenFactory(), true));
